...
// Plugging in Motion
theta3=-asin(Y/L1)*180/Pi;       //angle between final main arm location and x axis
...
//    delay(1000); 
//    Serial.println(theta3);
//    float newtheta3=abs(theta3);
//    Serial.println(newtheta3);
//    Serial.println((HomeA-theta1));
//    float ArmFinalPosition=(((-1*theta3))-(HomeA-theta1))+(HomeA-theta1);
//    Serial.println(ArmFinalPosition);
//    
//    float TipPosition2=TipPosition1+(theta1-newtheta3)-90;
//    
//    for (int pos = (HomeA-theta1); pos <= ArmFinalPosition; pos += 1) { // goes from 0 degrees to 180 degrees in steps of 1 degree
//      ArmServo.write(pos);              // tell servo to go to position in variable 'pos'
//      Serial.println(pos);
//      delay(7);                       // waits 15ms for the servo to reach the position
//
//    for (int posT = TipPosition1; posT >= TipPosition2; posT -= 1) { // goes from 0 degrees to 180 degrees in steps of 1 degree
//      TipServo.write(posT);              // tell servo to go to position in variable 'pos'
//      delay(7);                       // waits 15ms for the servo to reach the position
//      Serial.println(posT);
//      } 
//
...
//    Serial.println(theta1);
//    float TipPosition2=TipPosition1+(theta1-newtheta3)-90;
//    Serial.print("TipPosition1= ");
//    Serial.println(TipPosition1);
//    Serial.print("TipPosition2= ");
...
// Horizontal Gantry Move To Final Position
