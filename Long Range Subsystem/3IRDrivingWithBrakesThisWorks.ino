...
const int turnSlowSpeed = 70;
const int turnFastSpeed = 85;
const int goSpeed = 80;
const int stopSpeed = 60;
...
{if(flag==0){
  ...
  //read limit switch
  int bump = digitalRead(switchPin);
...
if (distance1<StopDist || distance2<StopDist || bump==1){
  Stop();
